...
if [ "$COWRIE_INSTALLED" = "false" ]; then
    ...
    chmod -R 755 "$COWRIE_INSTALL_DIR/cowrie/cowrie-env/lib/"
fi
...
# 查找 site-packages 目录
SITE_PACKAGES_DIR=$(find "$COWRIE_INSTALL_DIR/cowrie/cowrie-env/lib/" -maxdepth 3 -type d -name "site-packages" -print -quit)
